...
import { Card, CardMedia, CardContent, CardActions, Typography, IconButton, Switch, Box, Chip, Divider, Tooltip } from '@mui/material';
  ...
  return (
    ...
    >
      ...
      <CardContent sx={{ flexGrow: 1 }}>
        <Typography variant="h6" component="div" title={manhwa.manhwaName}>
          {manhwa.manhwaName}
        </Typography>
        <Chip label={manhwa.providerName} size="small" sx={{ mt: 1 }} />
        <Divider sx={{ my: 1 }} />
